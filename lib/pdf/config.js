...
config.options = {
  ...
  "footer": {
    "height": "18mm",
    "contents": '<span style="font-size: 10px; position: absolute; top: 0; left: 75px; display: block;">Alle Angaben und Berechnungen ohne Gewähr. </span><span style="font-size: 10px; position: absolute; top: 0; left: 600px; display: block;">Seite {{page}} von {{pages}}</span><br>'
  },/*,
  header: {
   height: "25mm",
   contents: '<div style="text-align: center;">Author: Benjamin Tanz</div>'
   }*/
  // phantom script options
  //timeout: 60000
