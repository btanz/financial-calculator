...
annuity.schedule = function(inputs){
  ...
  var i, j, k, disagioTotal, feesTotal, repaymentfreeTotal = 0, repaymentfreeTotalInitiallyAdded;
  ...
  scheduleResidual = function(principal, repay, term, repayfreq, interest, noamortization){
    var i;
  ...
  if(this.mode === 1){
    ...
    /** create schedule */
    dyn = scheduleResidual(this.principal, this.repay, this.term, this.repayfreq, this.interest, false);
