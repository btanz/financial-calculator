 ...
 *
 * If options.removeParentheses is true, all content in parentheses is removed, that is,
 ...
 *
 * See method availabiltyIntersection for the newest and oldest date for
 ...
 */
Quandl.prototype.availabiltyIntersection = function(){
  var result = [],
      helper = [],
